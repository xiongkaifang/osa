...
#if !defined (__OSA_TSK_DRV_TEST1_H)
#define __OSA_TSK_DRV_TEST1_H
 ...
 *  ============================================================================
 */
extern task_common_object_t glb_tsk_obj1;

extern status_t tsk_drv_test1_main(void *ud, task_t tsk, msg_t **msg);
