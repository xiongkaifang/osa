 ...
 *
 *  @File name:	thr_pool.c
 *
 *  @Author: xiong-kaifang   Version: v1.0   Date: 2015-09-08
 *
 *  @Description:   The description of this file.
 *
 *                  The implementation of thread pool(By Oracle).
 *
 *  @Version:       v1.0
 *
 ...
 *  @Macro:         POOL_WAIT
 *
 *  @Description:   waiting in thr_pool_wait().
 *  ============================================================================
 */
 ...
 *  @Macro:         POOL_DESTROY
 *
 *  @Description:   pool is being destroyed.
 *  ============================================================================
 */
 ...
 *  @Name:          job_t
 *
 *  @Description:   FIFO queued job.
 *
 *  @Field:         job_next: linked list of jobs.
 *
 *                  job_func: function to call.
 *
 *                  job_arg : its argument
 *
 *  @Field          Field2 member
 *  ----------------------------------------------------------------------------
 */
 ...
 *  @Name:          active_t
 *
 *  @Description:   List of active worker threads, linked through their stacks.
 *
 *  @Field:         active_next: linked list of threads.
 *
 *                  active_tid : active thread id.
 *
 *  @Field          Field2 member
 *  ----------------------------------------------------------------------------
 */
 ...
 *  @Name:          thr_pool
 *
 *  @Description:   The thread pool, opaque to the clients.
 *
 *  @Field:         pool_forw
 *                      circular linked list of all thread pools.
 *  @Field          pool_back
 *                      circular linked list of all thread pools.
 *  @Field          pool_mutex
 *                      protects the pool data.
 *  @Field          pool_busycv
 *                      synchronization in pool_queue.
 *  @Field          pool_workcv
 *                      synchronization with workers.
 *  @Field          pool_waitcv
 *                      synchronization in pool_wait().
 *   @Field         pool_active
 *                      list of threads performing work.
 *  @Field          pool_head
 *                      head of FIFO job queue.
 *  @Field          pool_tail
 *                      tail of FIFO job queue.
 *  @Field          pool_attr
 ...
 *  @Name:          thr_pools
 *
 *  @Description:   the list of all created and not yet destroyed thread pools.
 * -----------------------------------------------------------------------------
 */
 ...
 *  @Name:          thr_pool_lock
 *
 *  @Description:   protects thr_pools.
 * -----------------------------------------------------------------------------
 */
 ...
 *  @Name:          fillset
 *
 *  @Description:   set of all signals.
 * -----------------------------------------------------------------------------
 */
 ...
 */
thr_pool_t *
thr_pool_create(uint_t min_threads, uint_t max_threads, uint_t linger, pthread_attr_t *attr)
{
    thr_pool_t	*pool;
 ...
 *
 *  @Description:   Worker thread is terminating.  Possible reasons:
 *
 *                  1. excess idle thread is terminating because there is no work.
 *
 *                  2. thread was cancelled (pool is being destroyed).
 *
 *                  3. the job function called pthread_exit().
 *
 *                  In the last case, create another worker thread if necessary
 *                  to keep the pool populated.
 *
 *  ============================================================================
 */
static void   worker_cleanup(thr_pool_t *pool)
 ...
 *
 *  @Description:   Called by a worker thread on return from a job.
 *
 *  ============================================================================
 */
static void   job_cleanup(thr_pool_t *pool)
