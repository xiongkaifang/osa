...
#if !defined (__OSA_TSK_DRV_TEST3_H)
#define __OSA_TSK_DRV_TEST3_H
...
extern status_t tsk_drv_test3_main(task_t tsk, msg_t **msg, void *ud);

#if defined(__cplusplus)
}
#endif  /* defined(__cplusplus) */

#endif  /* if !defined (__OSA_TSK_DRV_TEST3_H) */
