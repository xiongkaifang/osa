 ...
 *  ----------------------------------------------------------------------------
 */
struct __task_driver_test1_object_t
{
    const char   *  m_name;
...
typedef struct __task_driver_test1_object_t task_driver_test1_object_t;

/*
 *  --------------------- Global variable definition ---------------------------
 */
static task_driver_test1_object_t glb_tsk_drv_test1 = {
    .m_name       = "TSK_TEST_OBJECT1"
};

task_object_t glb_tsk_obj1 = {
    .m_name       = "TSK_TEST_OBJECT1",
    .m_main       = tsk_drv_test1_main,
    .m_pri        = 0,
    .m_stack_size = 0,
    .m_init_state = 0,
    .m_userdata   = &glb_tsk_drv_test1
};
...
static status_t
__task_drv1_timer_event_handler(void *ud)
{
    return task_mgr_synchronize(&glb_tsk_obj1, OSA_TSK_DRV_CMD_PROC, NULL, 0, 0);
}
...
static status_t task_do_initialize(HANDLE hdl, task_t tsk, msg_t *msg)
{
    ...
    tsk_hdl = (task_driver_test1_object_t *)hdl;

    tsk_hdl->m_event.m_fxn    = __task_drv1_timer_event_handler;
...
static status_t task_do_synchronize(void *ud, task_t tsk, msg_t *msg)
{
    ...
    tsk_hdl = (task_driver_test1_object_t *)ud;
