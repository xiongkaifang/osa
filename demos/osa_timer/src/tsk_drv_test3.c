...
static status_t
__task_drv3_timer_event_handler(void *ud)
{
    return task_mgr_synchronize(&glb_tsk_obj3, OSA_TSK_DRV_CMD_PROC, NULL, 0, 0);
}
...
static status_t task_do_initialize(HANDLE hdl, task_t tsk, msg_t *msg)
{
    ...
    tsk_hdl->m_event.m_fxn    = __task_drv3_timer_event_handler;
