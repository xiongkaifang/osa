 ...
 *  ----------------------------------------------------------------------------
 */
struct __task_driver_test4_object_t
{
    const char   *  m_name;
...
typedef struct __task_driver_test4_object_t task_driver_test4_object_t;

/*
 *  --------------------- Global variable definition ---------------------------
 */
static task_driver_test4_object_t glb_tsk_drv_test4 = {
    .m_name       = "TSK_TEST_OBJECT4"
};

task_object_t glb_tsk_obj4 = {
    .m_name       = "TSK_TEST_OBJECT4",
    .m_main       = tsk_drv_test4_main,
    .m_pri        = 0,
    .m_stack_size = 0,
    .m_init_state = 0,
    .m_userdata   = &glb_tsk_drv_test4
};
...
static status_t
__task_drv4_timer_event_handler(void *ud)
{
    return task_mgr_synchronize(&glb_tsk_obj4, OSA_TSK_DRV_CMD_PROC, NULL, 0, 0);
}
 ...
 *  ============================================================================
 */
status_t tsk_drv_test4_main(void *ud, task_t tsk, msg_t **msg)
{
...
static status_t task_do_initialize(HANDLE hdl, task_t tsk, msg_t *msg)
{
    ...
    task_driver_test4_object_t * tsk_hdl = NULL;

    tsk_hdl = (task_driver_test4_object_t *)hdl;

    tsk_hdl->m_event.m_fxn    = __task_drv4_timer_event_handler;
...
static status_t task_do_synchronize(void *ud, task_t tsk, msg_t *msg)
{
    ...
    tsk_hdl = (task_driver_test4_object_t *)ud;
