...
#if !defined (__OSA_TASK_DRV_H)
#define __OSA_TASK_DRV_H
 ...
 *  ============================================================================
 */
#define OSA_TASK_CMD_PRINT_TSKSTATS (0x8000)

#define OSA_TASK_CMD_PRINT_THDSTATS (0x8001)
...
#endif  /* if !defined (__OSA_TASK_DRV_H) */
