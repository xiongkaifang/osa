 ...
 *
 *  xiong-kaifang   2015-09-19     v1.1         1. Changed mailbox_t to opaque
 *                                                 type 'HANDLE'.
 *                                              2. Delete two routines:
 *                                                 mailbox_system_register
 *                                                 mailbox_system_unregister
 *                                              3. Tweak mailbox_close's
 *                                                 prototype.
 *
 *  ============================================================================
 */
